...
{
    public class AuditoriaBusqueda
    {
        ...
        public string TipoBusqueda { get; set; } // TipoBusqueda (length: 15)
        public int? Estado { get; set; } // Estado
        public int? TipoMaterial { get; set; } // TipoMaterial
        public string PalabrasClave { get; set; } // PalabrasClave
        public string Propietario { get; set; } // Propietario (length: 5)

        public AuditoriaBusqueda()
        {
